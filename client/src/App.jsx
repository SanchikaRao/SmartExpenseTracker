...
import { LayoutDashboard, Camera, PlusCircle, History, LogOut } from 'lucide-react';
          ...
          <main className="p-4 flex-1 overflow-y-auto pb-24 space-y-3">
            {!user ? (
              ...
              <Routes>
                ...
                />
                <Route path="/scan" element={<div className="pt-2"><ReceiptScanner /></div>} />
                <Route path="/add" element={<div className="pt-2"><ExpenseForm /></div>} />
                <Route path="/history" element={<div className="pt-2"><ExpenseList /></div>} />
              </Routes>
            )}
          </main>
